...
/**
 * <p>
 * Java class for BERolloverTextItemType complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="BERolloverTextItemType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="stf_LightboxWebsiteURL" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "BERolloverTextItemType", propOrder = { "stfItemSubTitle", "ancReadMoreLink", "imgItemImage",
	"imgLightboxImage", "mdaItemPDFDownloadLink", "stfItemLightboxLinkText", "stfItemPDFDownloadLinkText",
	"stfItemReadMoreLinkText", "stfItemTeaserText", "stfItemTitle", "stfLightboxEmailAddress", "stfLightboxEmailLabel",
	"stfLightboxPartnerId", "stfLightboxWebsiteLabel", "stfLightboxWebsiteURL", "txtLightboxContentBody" })
public class BERolloverTextItemType {
	...
	@XmlElement(name = "stf_LightboxWebsiteURL")
	protected List<String> stfLightboxWebsiteURL;
	 ...
	 * <CODE>set</CODE> method for the stfLightboxWebsiteURL property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getStfLightboxWebsiteURL().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<String> getStfLightboxWebsiteURL() {
		if (stfLightboxWebsiteURL == null) {
			stfLightboxWebsiteURL = new ArrayList<String>();
		}
		return this.stfLightboxWebsiteURL;
	}
