...
/**
 * <p>Java class for con_gallery_itemsType complex type.
 * 
...
@XmlType(name = "con_gallery_itemsType", propOrder = {
    "beListingItemNoLightboxOrDivOrBEListingItemLightbox"
})
public class ConGalleryItemsType {

    @XmlElements({
        @XmlElement(name = "BEListingItemNoLightbox", type = BEListingItemNoLightboxType.class),
    ...
    /**
     * Gets the value of the beListingItemNoLightboxOrDivOrBEListingItemLightbox property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beListingItemNoLightboxOrDivOrBEListingItemLightbox property.
     * 
     * <p>
