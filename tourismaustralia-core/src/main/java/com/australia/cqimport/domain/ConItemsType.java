...
/**
 * <p>Java class for con_itemsType complex type.
 * 
...
@XmlType(name = "con_itemsType", propOrder = {
    "beHomeNewsItem",
...
public class ConItemsType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the beHomeNewsItem property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the beGenericListWithHeaderItem property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
