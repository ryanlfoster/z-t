...
public class TagHelper {
	...
	private static final Map<String, String> tagTileMap = ImmutableMap.<String, String> builder()
		.put("en", "jcr:title.en").put("it", "jcr:title.it").put("fr", "jcr:title.fr").put("de", "jcr:title.de")
		.put("es", "jcr:title.es").put("id", "csv/mapping_id.csv").put("jp", "jcr:title.ja")
		.put("ko", "cr:title.ko_kr").put("my", "csv/mapping_my.csv").put("pt", "csv/mapping_pt.csv")
		.put("zht", "jcr:title.zh_cn").build();
			...
			while (nodes.hasNext()) {
				...
				try {
					...
					if (tempStr != null) {
						...
						// For child nodes you have to include the
						// ta:parentName/childName
