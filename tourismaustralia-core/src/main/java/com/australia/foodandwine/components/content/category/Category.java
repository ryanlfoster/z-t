...
@Component(disableTargeting = true, group = "Food and Wine", basePath = "jcr_root/apps/foodandwine/components", value = "Category", dialogWidth = 700, dialogHeight = 500, listeners = {
