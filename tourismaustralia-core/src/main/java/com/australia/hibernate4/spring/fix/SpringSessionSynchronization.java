...
/**
 * Callback for resource cleanup at the end of a Spring-managed transaction for
 * a pre-bound Hibernate Session.
 *
...
class SpringSessionSynchronization implements TransactionSynchronization, Ordered {
	...
	public void suspend() {
		if (this.holderActive) {
			...
			// Eagerly disconnect the Session here, to make release mode
			// "on_close" work on JBoss.
