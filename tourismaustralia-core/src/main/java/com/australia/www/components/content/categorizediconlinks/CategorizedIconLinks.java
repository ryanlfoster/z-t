...
public class CategorizedIconLinks {
    ...
    public CategorizedIconLinks(SlingHttpServletRequest request) {
		...
		titleText1.setIconLink1(properties.get("title1/iconLink1", StringUtils.EMPTY));
		...
		titleText1.setIconLink2(properties.get("title1/iconLink2", StringUtils.EMPTY));
		...
		titleText1.setIconLink3(properties.get("title1/iconLink3", StringUtils.EMPTY));
		...
		titleText2.setIconLink1(properties.get("title2/iconLink1", StringUtils.EMPTY));
		...
		titleText2.setIconLink2(properties.get("title2/iconLink2", StringUtils.EMPTY));
		...
		titleText2.setIconLink3(properties.get("title2/iconLink3", StringUtils.EMPTY));
		...
		titleText3.setIconLink1(properties.get("title3/iconLink1", StringUtils.EMPTY));
		...
		titleText3.setIconLink2(properties.get("title3/iconLink2", StringUtils.EMPTY));
		...
		titleText3.setIconLink3(properties.get("title3/iconLink3", StringUtils.EMPTY));
