...
public class CategorizedIconLinks {
	...
	public CategorizedIconLinks(SlingHttpServletRequest request) {
		...
		if (properties != null) {
			...
			titleText1.setIconLink1IsExternal(LinkUtils.isExternal(properties
				.get("title1/iconLink1", StringUtils.EMPTY)));
			...
			titleText1.setIconLink2IsExternal(LinkUtils.isExternal(properties
				.get("title1/iconLink2", StringUtils.EMPTY)));
			...
			titleText1.setIconLink3IsExternal(LinkUtils.isExternal(properties
				.get("title1/iconLink3", StringUtils.EMPTY)));
			...
			titleText2.setIconLink1IsExternal(LinkUtils.isExternal(properties
				.get("title2/iconLink1", StringUtils.EMPTY)));
			...
			titleText2.setIconLink2IsExternal(LinkUtils.isExternal(properties
				.get("title2/iconLink2", StringUtils.EMPTY)));
			...
			titleText2.setIconLink3IsExternal(LinkUtils.isExternal(properties
				.get("title2/iconLink3", StringUtils.EMPTY)));
			...
			titleText3.setIconLink1IsExternal(LinkUtils.isExternal(properties
				.get("title3/iconLink1", StringUtils.EMPTY)));
			...
			titleText3.setIconLink2IsExternal(LinkUtils.isExternal(properties
				.get("title3/iconLink2", StringUtils.EMPTY)));
			...
			titleText3.setIconLink3IsExternal(LinkUtils.isExternal(properties
				.get("title3/iconLink3", StringUtils.EMPTY)));
