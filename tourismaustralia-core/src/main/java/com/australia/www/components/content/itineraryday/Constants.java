...
final class Constants {
    ...
    public static final String NAME_HERO_TITLE = "heroTitle";
    public static final String NAME_IMAGE_1 = "image1";
    public static final String NAME_IMAGE_1_ALT_TEXT = "image1AltText";
    public static final String NAME_IMAGE_2 = "image2";
    public static final String NAME_IMAGE_2_ALT_TEXT = "image2AltText";
    public static final String NAME_IMAGE_3 = "image3";
    public static final String NAME_IMAGE_3_ALT_TEXT = "image3AltText";
    public static final String NAME_IMAGE_4 = "image4";
