 ...
 */
@Component(value = "Itinerary Day", tabs = { @Tab(title = Constants.TAB_TEXT_NAME),
	@Tab(title = Constants.TAB_HERO_NAME), @Tab(title = Constants.TAB_IMAGE_1_NAME),
	@Tab(title = Constants.TAB_IMAGE_2_NAME), @Tab(title = Constants.TAB_IMAGE_3_NAME),
	@Tab(title = Constants.TAB_IMAGE_4_NAME), @Tab(title = Constants.TAB_MAP_NAME) }, listeners = {
	@Listener(name = "afteredit", value = "REFRESH_PARENT"), @Listener(name = "afterinsert", value = "REFRESH_PARENT"),
	@Listener(name = "aftermove", value = "REFRESH_PARENT"), @Listener(name = "afterremove", value = "REFRESH_PARENT") })
public final class ItineraryDay {

	/**
	 * Backing bean representing a link to a sibling ItineraryDay, used for
	 * building the list of day links
	 */
	...
	@Html5SmartImage(tab = false, name = Constants.NAME_HERO_IMAGE, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
	private final String heroImage;

	@DialogField(fieldLabel = "Hero Image Title", tab = Constants.TAB_HERO_INDEX, required = true)
	private final String heroTitle;

	@DialogField(fieldLabel = "Hero Image Alt Text", tab = Constants.TAB_HERO_INDEX, required = true, xtype = "textarea", additionalProperties = { @FieldProperty(name = "grow", value = "true") })
	private final String heroImageAltText;

	@DialogField(fieldLabel = "Image 1 (16:9)", tab = Constants.TAB_IMAGE_1_INDEX)
	@Html5SmartImage(tab = false, name = Constants.NAME_IMAGE_1, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
	private final String image1;

	@DialogField(fieldLabel = "Image 1 Alt Text", tab = Constants.TAB_IMAGE_1_INDEX, xtype = "textarea", additionalProperties = { @FieldProperty(name = "grow", value = "true") })
	private final String image1AltText;

	@DialogField(fieldLabel = "Image 2 (16:9)", tab = Constants.TAB_IMAGE_2_INDEX)
	@Html5SmartImage(tab = false, name = Constants.NAME_IMAGE_2, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
	private final String image2;

	@DialogField(fieldLabel = "Image 2 Alt Text", tab = Constants.TAB_IMAGE_2_INDEX, xtype = "textarea", additionalProperties = { @FieldProperty(name = "grow", value = "true") })
	private final String image2AltText;

	@DialogField(fieldLabel = "Image 3 (1:1)", tab = Constants.TAB_IMAGE_3_INDEX)
	@Html5SmartImage(tab = false, name = Constants.NAME_IMAGE_3, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
	private final String image3;

	@DialogField(fieldLabel = "Image 3 Alt Text", tab = Constants.TAB_IMAGE_3_INDEX, xtype = "textarea", additionalProperties = { @FieldProperty(name = "grow", value = "true") })
	private final String image3AltText;

	@DialogField(fieldLabel = "Image 4 ", tab = Constants.TAB_IMAGE_4_INDEX)
	@Html5SmartImage(tab = false, name = Constants.NAME_IMAGE_4, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
	private final String image4;

	@DialogField(fieldLabel = "Image 4 Alt Text", tab = Constants.TAB_IMAGE_4_INDEX, xtype = "textarea", additionalProperties = { @FieldProperty(name = "grow", value = "true") })
	private final String image4AltText;

	@DialogField(fieldLabel = "Map Image", tab = Constants.TAB_MAP_INDEX)
	@Html5SmartImage(tab = false, name = Constants.NAME_MAP_IMAGE, height = Constants.IMAGE_WIDGET_HEIGHT, fileReferenceParameter = Constants.FILE_REF_NAME)
