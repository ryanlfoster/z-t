...
/**
 * Backing Bean for CQ Component responsible 
 * Created by Lance Dolan 4/02/14.
 */
...
public class Links {
    ...
    public Links(SlingHttpServletRequest request) {
        ...
        linksList = LinkUtils.populateLinksFromMultiComposite(
                new ArrayList<Link>(), thisResource, 
                PROP_LINKS_LIST, Link.PROP_PATH, Link.PROP_TITLE );
    }
