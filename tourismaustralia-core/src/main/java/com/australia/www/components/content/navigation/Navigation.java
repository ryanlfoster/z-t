 ...
 */
@Component(value = "Navigation", dialogWidth = 600, disableTargeting = true, group = ".hidden",
	tabs = { @Tab(title = "Arrival Bar"), @Tab(title = "Navigation Bar"), @Tab(title = "Megamenu 1"),
...
public class Navigation {
	...
	public Navigation(SlingHttpServletRequest request) {
		...
		if (navigationResource != null) {
			...
			buildTextLinkWithState(megamenu2LhsCategoryTitle1Links, navigationResource,
				"megamenu2LhsCategoryTitle1Links");

			megamenu2LhsCategoryTitle2Links = new ArrayList<TextLinkWithState>();
			buildTextLinkWithState(megamenu2LhsCategoryTitle2Links, navigationResource,
				"megamenu2LhsCategoryTitle2Links");

			megamenu2LhsCategoryTitle3Links = new ArrayList<TextLinkWithState>();
			buildTextLinkWithState(megamenu2LhsCategoryTitle3Links, navigationResource,
				"megamenu2LhsCategoryTitle3Links");
	...
	public String getMegamenu2LhsCategoryTitle1() {
		return megamenu2LhsCategoryTitle1;
	}

	public List<TextLinkWithState> getMegamenu2LhsCategoryTitle1Links() {
		return megamenu2LhsCategoryTitle1Links;
	}

	public String getMegamenu2LhsCategoryTitle2() {
		return megamenu2LhsCategoryTitle2;
	}

	public List<TextLinkWithState> getMegamenu2LhsCategoryTitle2Links() {
		return megamenu2LhsCategoryTitle2Links;
	}

	public String getMegamenu2LhsCategoryTitle3() {
		return megamenu2LhsCategoryTitle3;
	}

	public List<TextLinkWithState> getMegamenu2LhsCategoryTitle3Links() {
		return megamenu2LhsCategoryTitle3Links;
	}
