...
public class SpecialOffer {
	...
	public SpecialOffer(SlingHttpServletRequest request) {
		...
		viewMoreInformationLink = LinkUtils.getHrefFromPath(properties
			.get("viewMoreInformationLink", StringUtils.EMPTY));
		viewMoreInformationLinkIsExternal = LinkUtils.isExternal(properties.get("viewMoreInformationLink",
			StringUtils.EMPTY));
		viewTermsAndConditionLink = LinkUtils.getHrefFromPath(properties.get("viewTermsAndConditionLink",
			StringUtils.EMPTY));
		viewTermsAndConditionLinkIsExternal = LinkUtils.isExternal(properties.get("viewTermsAndConditionLink",
			StringUtils.EMPTY));
	}
	...
	public boolean getViewMoreInformationLinkIsExternal() {
		return viewMoreInformationLinkIsExternal;
	}
	...
	public boolean getViewTermsAndConditionLinkIsExternal() {
		return viewTermsAndConditionLinkIsExternal;
	}
}
