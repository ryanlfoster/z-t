 ...
 */
@Component(value = "Two Column Brightcove Video", disableTargeting = true, tabs = {@Tab(title = "General"), @Tab(title = "Account Settings"), @Tab(title = "Video Information")}, dropTargets = @DropTarget(propertyName = "./videoPlayer", groups = "media", nodeName = "brightcovevideo", accept = "[.*]"), listeners = {
