...
public class TextLinkWithState {
	...
	@Selection(type = Selection.SELECT, options = { @Option(value = "vic", text = "Victoria"),
		@Option(value = "nsw", text = "New South Wales"), @Option(value = "qld", text = "Queensland"),
		@Option(value = "sa", text = "South Australia"), @Option(value = "nt", text = "Northern Territory"),
		@Option(value = "wa", text = "Western Australia"),
		@Option(value = "act", text = "Australian Capital Territory"), @Option(value = "tas", text = "Tasmania") })
