...
module.exports = function( grunt ) {
    ...
    grunt.initConfig({
       ...
       // MARKDOWN: 'assets/md',
        ...
        ASSET_CQ: '../tourismaustralia-ui/src/main/content/jcr_root/etc/designs/tourismaustralia/clientlibs', // path to local cq project clientlibs folder
        PROD: 'www',
        ...
        copyto: {
            ...
            styleguide: {
                files: [
                    { cwd: '<%= STYLEGUIDE %>/js/', src: ['src/*', 'vendor/*', 'vendor/owl-carousel/*', 'vendor/responsive-iamges/*'], dest: '<%= PROD %>/js/' }
                ]
            },
            assetOut: {
                files: [
            ...
            // copies asset output to cq build
            cq: {
                files: [
