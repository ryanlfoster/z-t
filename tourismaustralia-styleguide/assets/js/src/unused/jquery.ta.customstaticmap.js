...
;(function($, window, document, undefined) {
	...
	Plugin.prototype.checkJsonDataTags = function(scope) {
		...
		DataTagHelper.setDataTag(scope.element, 'data-mapmarkerjson', scope.options.mapJsonPath);
		
		DataTagHelper.setDataTag(scope.element, 'data-enablenavigation', scope.options.mapJsonPath);
		
		DataTagHelper.setDataTag(scope.element, 'data-enablezooming', scope.options.mapJsonPath);
		
		DataTagHelper.setDataTag(scope.element, 'data-centerlat', scope.options.mapJsonPath);
		
		DataTagHelper.setDataTag(scope.element, 'data-centerlong', scope.options.mapJsonPath);
		
		DataTagHelper.setDataTag(scope.element, 'data-zoom', scope.options.mapJsonPath, true);
