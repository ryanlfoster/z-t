...
<div class="footer-restaurant-australia-elements">
    <!-- <a href="#" class="btn-restaurant-australia-logo icon-font-logo"></a> -->
...
<div class="footer-col">
    <p class="footer-heading">Restaurant Australia</p>
    <ul class="footer-text-list l-list-clean">
        <li><a href="#">Restaurant Australia</a></li>
...
<div class="footer-col">
    ...
    <ul class="footer-social-list type-spacing-15">
        ...
        <li><a href="#" class="btn-share icon-font-instagram icon-colour-grey"><span>Instagram</span></a></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 l-footer-align l-footer-logo-align">
<div class="footer-col footer-logo-fixed-height">
    <div class="footer-ta-logo-container">
        <a href="#"><img class="type-spacing-15" src="imgs/logo/logo-tourism-australia.png"></a>
        <div class="footer-ta-logo-copyright">© Tourism Australia 2014</div>
    </div>
</div>
            </div>
        </div>
