	...
	<div class="faw-hero-home-container">
		...
		<div class='calltoaction calltoactionvideo'>
			<div class="calltoaction-title-container is-mobile">
				<div class="calltoaction-type-sml1">${hero.smallText}
					${hero.largeText}</div>
			</div>
			...
			<div class="head-divider-inner">
				...
				<a href="#" class="faw-video-teaser-icon btn-round-video icon-font-video-play"
		...
		<div class="faw-register-teaser">
			...
			<p>
				<a href="${hero.buttonLink}"
					class="btn-secondary btn-transparent btn-small"
					target="${hero.external ? '_BLANK' : '_self'}">${hero.buttonText}</a>
			</p>
				...
				<div class="cq-dd-brightcovevideo"
					...
					<script type="text/javascript">
						...
						function onMediaBegin(event) {
							...
							BCLcurrentVideoID = BCLvideoPlayer
									.getCurrentVideo().id;
							BCLcurrentVideoNAME = BCLvideoPlayer
									.getCurrentVideo().displayName;
							switch (event.type) {
							case "mediaBegin":
								var currentVideoLength = "0";
								currentVideoLength = BCLvideoPlayer
										.getCurrentVideo().length;
					...
					<script>
						customBC.createVideo("100%", "100%",
								"${hero.playerId}", "${hero.playerKey}",
								"${hero.videoPlayer}", "${hero.videoRandomId}");
					</script>
				</div>
			</div>
		</div>
