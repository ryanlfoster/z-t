<div class="row l-row-collapse">
	{{#each searchResults}} {{#compare @index 0 operator="=="}} {{#if
	templateName}}
		...
		{{#if linkChecker}} <a href="{{postLink}}" title=""
			...
			class="mosaic-item mosaic-item-{{../../../../type}}" target="_blank"> {{/if}} <img
				...
				<span class="mosaic-item-description"> <span
					...
					class="mosaic-item-description-copy"> {{pageDescription}} <br>
					...
					<span class="mosaic-item-overlay-share-container"> <span
						class="mosaic-item-overlay-share-copy"> {{messagePosts}} <br>
			...
			<span class="mosaic-item-description"> <span
				...
				class="mosaic-item-overlay-info-icon"> <span
					...
					<span class="mosaic-item-overlay-info-icon-item"> <img
						src="{{icon}}" alt="">
				</span> <span class="mosaic-item-overlay-info-desciption"> {{city}}
						<br> <br> <span
	...
	<div class="col-xs-12 {{#if isGrid}}col-md-6{{else}}col-reset-md-6{{/if}} 3">
		<div class="row">
			{{#each searchResults}} {{#compare @index 1 operator="=="}} {{#if
			templateName}}
				...
				{{#if linkChecker}} <a href="{{postLink}}" title=""
					...
					class="mosaic-item mosaic-item-{{../../../../type}}" target="_blank"> {{/if}} <img
						...
						<span class="mosaic-item-description"> <span
							...
							<span class="mosaic-item-overlay-share-container"> <span
								class="mosaic-item-overlay-share-copy"> {{messagePosts}}
									<br>
								<br> <strong>{{userName}} on {{templateName}}</strong>
							</span>
						</span>
			...
			{{else}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 4">
				<a href="{{link}}" class="mosaic-item mosaic-item-{{../../../type}}" title=""> <img
					class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
			...
			templateName}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 5">
				{{#if linkChecker}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}"> {{else}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}" target="_blank"> {{/if}} <img
						class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
			...
			{{else}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 6">
				<a href="{{link}}" class="mosaic-item mosaic-item-{{../../../type}}" title=""> <img
					class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
			...
			templateName}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 7">

				{{#if linkChecker}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}"> {{else}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}" target="_blank"> {{/if}} <img
						class='mosaic-item-image' src="{{image}}" alt="" width="100%" /> <span
			...
			{{else}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 8">
				<a href="{{link}}" class="mosaic-item mosaic-item-{{../../../type}}" title=""> <img
					class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
			...
			templateName}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 9">
				{{#if linkChecker}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}"> {{else}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}" target="_blank"> {{/if}} <img
						class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
			...
			{{else}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} 10">
				<a href="{{link}}" class="mosaic-item mosaic-item-{{../../../type}}" title=""> <img
					class='mosaic-item-image' src="{{imagePath}}" alt="" width="100%" />
...
<div class="row l-row-collapse">
	<div class="col-xs-12 {{#if isGrid}}col-md-3{{else}}col-reset-md-3{{/if}} mosaic-ie-25">
		<div class="row">
			{{#each searchResults}} {{#compare @index 5 operator="=="}} {{#if
			templateName}}
			...
			{{/if}} {{/compare}} {{#compare @index 6 operator="=="}} {{#if
			templateName}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} col-md-12 mosaic-ie-100">
				{{#if linkChecker}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}"> {{else}} <a href="{{postLink}}" title=""
	...
	<div class="col-xs-12 {{#if isGrid}}col-md-3{{else}}col-reset-md-3{{/if}} mosaic-ie-25">
		<div class="row">
			{{#each searchResults}} {{#compare @index 8 operator="=="}} {{#if
			templateName}}
			<div class="col-xs-12 {{#if ../../../isGrid}}col-sm-6{{else}}col-reset-sm-6{{/if}} col-md-12 mosaic-ie-100">
				{{#if linkChecker}} <a href="{{postLink}}" title=""
					class="mosaic-item mosaic-item-{{../../../../type}}"> {{else}} <a href="{{postLink}}" title=""
