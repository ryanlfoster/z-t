...
<a href="#" class="favourite favourite-btn" data-pagepath="${favourite.pagePath}">
    <span class="btn-bubble">
        <span class="btn-bubble-button">
            <img class="btn-bubble-std" src="/etc/designs/tourismaustralia/clientlibs/imgs/icons/favourite_white_outline.png" alt="">
            <img class="btn-bubble-active" src="/etc/designs/tourismaustralia/clientlibs/imgs/icons/favourite_white.png" alt="">
        </span>
    </span>
