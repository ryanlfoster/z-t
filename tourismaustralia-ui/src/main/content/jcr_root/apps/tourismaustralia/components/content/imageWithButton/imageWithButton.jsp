...
<div class="image-ugc-container">
    <div class="image-ugc image-with-button make-white">
        <c:if test="${not empty imageButton.mainImageSrc && not empty imageButton.mainImageAlt }">
        ...
        <c:if test="${not empty imageButton.quoteText || ( not empty imageButton.imageButtonText && not empty imageButton.imageButtonPath )}">
        <div class="image-content-container">
			<div class="image-content">
				...
				<c:if test="${not empty imageButton.imageButtonText && not empty imageButton.imageButtonPath}">
                <hr>
